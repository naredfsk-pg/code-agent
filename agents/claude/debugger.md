...
Whenever you implement a fix or modify tests, apply these rules while preserving correctness, security, explicit requirements, necessary performance, and the mandatory 4-Mantra protocol:
...
- [ ] Fix and tests pass the highest-priority coding standards
